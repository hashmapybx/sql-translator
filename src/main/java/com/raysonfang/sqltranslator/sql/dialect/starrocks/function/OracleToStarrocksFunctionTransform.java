package com.raysonfang.sqltranslator.sql.dialect.starrocks.function;
...
import com.raysonfang.sqltranslator.sql.dialect.oracle.function.OracleFunction;
 ...
 * 模仿修改为oracle到 starrocks函数
 *
 * @author rayson.fang
 * @date 2021/02/05 12:38
 **/
public class OracleToStarrocksFunctionTransform implements OracleFunction {
